...
#define ICU_REGESYS_SIUL2_AR_RELEASE_MINOR_VERSION     0
#define ICU_REGESYS_SIUL2_AR_RELEASE_REVISION_VERSION  3
#define ICU_REGESYS_SIUL2_SW_MAJOR_VERSION             1
#define ICU_REGESYS_SIUL2_SW_MINOR_VERSION             1
...
#define SIUL2_DISR0_ADDR32                          (SIUL2_BASEADDR + 0x10UL)
#define SIUL2_DISR0_EIF                             (0xFFFFFFFFUL)

/* @brief DMA/Interrupt Request Enable Register address, bits and masks */
#define SIUL2_DIRER0_LOCKABLE_ADDR32                (SIUL2_BASEADDR + 0x18UL)
#define SIUL2_DIRER0_EIRE                           (0xFFFFFFFFUL)

/* @brief DMA/Interrupt Request Select Register address, bits and masks */
#define SIUL2_DIRSR0_LOCKABLE_ADDR32                (SIUL2_BASEADDR + 0x20UL)
#define SIUL2_DIRSR0_DIRSR                          (0xFFFFFFFFUL)

/* @brief Interrupt Rising Edge Event Register address, bits and masks */
#define SIUL2_IREER0_LOCKABLE_ADDR32                (SIUL2_BASEADDR + 0x28UL)
#define SIUL2_IREER0_IREE                           (0xFFFFFFFFUL)

/* @brief Interrupt Falling Edge Event Register address, bits and masks */
#define SIUL2_IFEER0_LOCKABLE_ADDR32                (SIUL2_BASEADDR + 0x30UL)
#define SIUL2_IFEER0_IFEE                           (0xFFFFFFFFUL)

/* @brief Interrupt Filter Enable Register address, bits and masks */
#define SIUL2_IFER0_LOCKABLE_ADDR32                 (SIUL2_BASEADDR + 0x38UL)
#define SIUL2_IFER0_IFE                             (0xFFFFFFFFUL)
...
*/
#define SIUL2_IFMCR_LOCKABLE_ADDR32(IFMC_OFFSET)   (SIUL2_BASEADDR + (IFMC_OFFSET) + 0x40UL)

/* @brief Interrupt Filter Maximum Counter mask */
#define SIUL2_IFMCR_MAXCNT                          (0x0000000FUL)


/*
* @brief Interrupt Filter Clock Prescaler Register
*/
#define SIUL2_IFCPR_LOCKABLE_ADDR32                 (SIUL2_BASEADDR + 0xC0UL)

/* @brief Interrupt Filter Clock Prescaler Register masks and shift counts */
#define SIUL2_IFCPR_IFCP                            (0x0000000FUL)
#define SIUL2_IFCPR_SHIFT                           (0U)
