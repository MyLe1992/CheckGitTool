...
#define ICU_TYPES_AR_RELEASE_MINOR_VERSION        0
#define ICU_TYPES_AR_RELEASE_REVISION_VERSION     3
#define ICU_TYPES_SW_MAJOR_VERSION                1
#define ICU_TYPES_SW_MINOR_VERSION                1
 ...
 * @implements     Icu_InputState_enumeration
 * */
typedef enum
{
...
typedef enum
{
    ...
    ICU_ACTIVE_TIME = 0x03U,            /*< @brief The channel is configured to read values which
                                         *          are needed for calculating the active time */
 ...
 * @implements Icu_LevelType_enumeration
 * */
typedef enum
{
