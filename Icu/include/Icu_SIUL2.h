...
#define ICU_SIUL2_AR_RELEASE_MINOR_VERSION     0
#define ICU_SIUL2_AR_RELEASE_REVISION_VERSION  3
#define ICU_SIUL2_SW_MAJOR_VERSION             1
#define ICU_SIUL2_SW_MINOR_VERSION             1
...
*/
#define SIUL2_IRQ_CHANNEL_MASK            (0xFFFFFFFFU)
/**@}*/
...
*/
#define SIUL2_IRQ_CHANNEL_GROUP_MASK_U32(hwChannel) \
            ((uint32)((BIT7|BIT6|BIT5|BIT4|BIT3|BIT2|BIT1|BIT0) << (hwChannel)))
/**
 * @brief   Channel mask
 * @violates @ref Icu_SIUL2_h_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
#define SIUL2_CHANNEL_MASK_U32(hwChannel) \
            (((uint32)BIT0 << (hwChannel)) & SIUL2_IRQ_CHANNEL_MASK)
...
* @violates @ref Icu_SIUL2_h_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined
*/
#define SIUL2_EIISR_ESEL_U32(hwChannel, value) \
