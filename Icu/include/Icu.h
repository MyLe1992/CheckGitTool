...
typedef struct
{
    ...
    Icu_ParamType Icu_RisingEdge_Filter;                 /*< @brief  Configuration parameters of
                                                         *           hardware channel registers. */
    Icu_ParamType Icu_FallingEdge_Filter;                /*< @brief  Configuration parameters of
                                                         *           hardware channel registers. */
...
typedef struct
{
    ...
    /*< @brief The global configuration paramters. */
    P2CONST(void, AUTOMATIC, ICU_APPL_CONST) Icu_GlobalConfiguration;

#if ((ICU_SIGNALMEASUREMENT_USES_DMA == STD_ON) || (ICU_TIMESTAMP_USES_DMA == STD_ON))
    P2CONST(Icu_DmaConfigType, AUTOMATIC, ICU_APPL_CONST) Icu_DmaConfig;
#endif
    ...
    CONST(Icu_ChannelType, ICU_CONST) (*Icu_ChannelId)[];

    /*< @brief This field keeps a pointer to array of hardware channels with the respective ICU ch*/
    CONST(Icu_ChannelType, ICU_CONST) (*Icu_HwMap)[];
} Icu_ConfigType;
