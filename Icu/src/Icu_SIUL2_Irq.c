...
#define ICU_SIUL2_IRQ_AR_RELEASE_MINOR_VERSION_C       0
#define ICU_SIUL2_IRQ_AR_RELEASE_REVISION_VERSION_C  3
#define ICU_SIUL2_IRQ_SW_MAJOR_VERSION_C             1
#define ICU_SIUL2_IRQ_SW_MINOR_VERSION_C               1
...
LOCAL_INLINE FUNC(void, ICU_CODE) Icu_Siul2_ProcessSingleInterrupt()
{
    ...
    {
        /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
         * to pointer.*/
        CONST(uint32, AUTOMATIC) u32RegSIUL2DISR = REG_READ32(SIUL2_DISR0_ADDR32);
        /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
         * to pointer.*/
        CONST(uint32, AUTOMATIC) u32RegSIUL2DIRER = REG_READ32(SIUL2_DIRER0_LOCKABLE_ADDR32);

        /* Clear pending interrupt serviced */
        /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
         * to pointer.*/
        REG_WRITE32(SIUL2_DISR0_ADDR32, u32RegSIUL2DISR);
    ...
    while(0x0U != u32RegIrqMask)
    {
        if (0x0U != (u32RegIrqMask & u32ChannelMask))
        {
            ...
            {
                Icu_IPW_ReportEvents(IRQ_ICU_CHANNEL((Icu_IPW_ChannelType)u8IrqChannel), (boolean)FALSE);
            }
...
LOCAL_INLINE FUNC(void, ICU_CODE) Icu_Siul2_ProcessInterrupt(CONST(uint8, AUTOMATIC) firstHwChannel)
{
    ...
    VAR(uint32, AUTOMATIC) u32ChannelMask = SIUL2_CHANNEL_MASK_U32((uint32)firstHwChannel);
    VAR(uint32, AUTOMATIC) u32RegIrqMask = SIUL2_IRQ_CHANNEL_GROUP_MASK_U32((uint32)firstHwChannel);
    ...
    SchM_Enter_Icu_ICU_EXCLUSIVE_AREA_15();
    {
        ...
        /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
         * to pointer.*/
        REG_WRITE32(SIUL2_DISR0_ADDR32, u32RegIrqMask & u32RegSIUL2DISR);
...
ISR(SIUL2_EXT_IRQ_0_7_ISR)
{
    Icu_Siul2_ProcessInterrupt(SIUL2_IRQ_0);
    /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
     * to pointer.*/
    EXIT_INTERRUPT();
}
...
ISR(SIUL2_EXT_IRQ_8_15_ISR)
{
    Icu_Siul2_ProcessInterrupt(SIUL2_IRQ_8);
    /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
     * to pointer.*/
    EXIT_INTERRUPT();
}
...
ISR(SIUL2_EXT_IRQ_16_23_ISR)
{
    Icu_Siul2_ProcessInterrupt(SIUL2_IRQ_16);
    /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
     * to pointer.*/
    EXIT_INTERRUPT();
}
...
ISR(SIUL2_EXT_IRQ_24_31_ISR)
{
    Icu_Siul2_ProcessInterrupt(SIUL2_IRQ_24);
    /* @violates @ref Icu_SIUL2_Irq_c_3 Violates MISRA 2004 Rule 11.1, Cast from unsigned long
     * to pointer.*/
    EXIT_INTERRUPT();
}
